...
/**
 * Taken from the MCMMO project
 * no rights reserved - use it for whatever you want with/without credit
 * (this may/may not apply to the original file in the MCMMO project, it does apply to this though)
 * pretty much a direct copy of {@link BlockWall}
 *
 * @author Cadiboo
 */
