	...
	public static void setState(boolean active, World worldIn, BlockPos pos) {
		...
		if (active) {
			worldIn.setBlockState(pos,
					BlocksRegistry.Lit_SnowFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)),
					3);
			worldIn.setBlockState(pos,
					BlocksRegistry.Lit_SnowFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)),
					3);
			...
			worldIn.setBlockState(pos,
					BlocksRegistry.SnowFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
			worldIn.setBlockState(pos,
					BlocksRegistry.SnowFurnace.getDefaultState().withProperty(FACING, iblockstate.getValue(FACING)), 3);
		}
