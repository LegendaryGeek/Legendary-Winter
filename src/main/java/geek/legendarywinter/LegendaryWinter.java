...
@Mod(modid = LegendaryWinter.MODID, name = LegendaryWinter.NAME, acceptedMinecraftVersions = "[1.12.2]", dependencies = "required-after:forge@[14.23.4.2739,)", version = LegendaryWinter.VERSION)
public class LegendaryWinter {
	 ...
	 *
	 */
	@SidedProxy(clientSide = "geek.legendarywinter.proxy.ClientProxy", serverSide = "geek.legendarywinter.proxy.ServerProxy")
